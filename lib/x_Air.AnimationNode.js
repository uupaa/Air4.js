...
function NodeA(boss,      // @arg Air
               ...
               options) { // @arg Object = {} - { loops, autoplay }
                          // @options.loops     Integer = 1 - loop times.
                          // @options.autoplay  Boolean = false - auto play
//{@dev
    if (!global["BENCHMARK"]) {
        $valid($type(cues, "Air2.Cue|Air2.CueArray"),       NodeA, "cues");
...
//}@dev
    ...
    Node.apply(this, [boss, id, "NodeA"]); // call super
...
// --- exports ---------------------------------------------
global["Air2_" in global ? "Air2_" : "Air2"]["NodeA"] = NodeA; // switch module. http://git.io/Minify
